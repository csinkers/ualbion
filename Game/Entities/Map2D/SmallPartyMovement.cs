...
namespace UAlbion.Game.Entities.Map2D
{
    public class SmallPartyMovement : ServiceComponent<IMovement>, IMovement
    {
        ...
        const int MinTrailDistance = 6;
        const int MaxTrailDistance = 12; // Max number of positions between each character in the party. Looks best if coprime to TicksPerPile and TicksPerFrame.
        ...
        public SmallPartyMovement(Vector2 initialPosition, MovementDirection initialDirection) : base(Handlers)
        {
        ...
        int SpriteFrame
        {
            get
            {
                ...
                var frames = SmallSpriteAnimations.Frames[anim];
