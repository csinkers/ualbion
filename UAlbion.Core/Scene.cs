...
namespace UAlbion.Core
{
    public class Scene
    {
        ...
        void RenderAllSingleThread(GraphicsDevice gd, CommandList cl, SceneContext sc)
        {
            ...
            {
                CameraLookDirection = Vector3.Normalize(Vector3.Reflect(_camera.LookDirection, MirrorMesh.Plane.Normal)),
                CameraPosition_WorldSpace = Vector3.Transform(_camera.Position, planeReflectionMatrix)
            };
        ...
        void RenderAllMultiThreaded(GraphicsDevice gd, CommandList cl, SceneContext sc)
        {
            ...
            foreach (var commandList in cls)
            {
                commandList.End();
            ...
            bool threaded)
        {
            ...
            renderQueue.AddRange((IReadOnlyList<Renderable>) cullRenderableList, viewPosition);
