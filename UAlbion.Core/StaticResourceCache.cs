...
namespace UAlbion.Core
{
    ...
    {
        static readonly Dictionary<GraphicsPipelineDescription, Pipeline> s_pipelines
            = new Dictionary<GraphicsPipelineDescription, Pipeline>();

        static readonly Dictionary<ResourceLayoutDescription, ResourceLayout> s_layouts
            = new Dictionary<ResourceLayoutDescription, ResourceLayout>();

        static readonly Dictionary<ShaderSetCacheKey, (Shader, Shader)> s_shaderSets
            = new Dictionary<ShaderSetCacheKey, (Shader, Shader)>();

        static readonly Dictionary<ImageSharpTexture, Texture> s_textures
            = new Dictionary<ImageSharpTexture, Texture>();

        static readonly Dictionary<Texture, TextureView> s_textureViews = new Dictionary<Texture, TextureView>();

        static readonly Dictionary<ResourceSetDescription, ResourceSet> s_resourceSets
