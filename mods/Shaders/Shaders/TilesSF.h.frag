...
layout(set = 2, binding = 0) uniform texture2D uTile; //!
layout(set = 2, binding = 1) uniform texture2DArray uTileArray; //!
layout(set = 2, binding = 2) uniform sampler uTileSampler; //!
...
layout(set = 2, binding = 4, std430) readonly buffer TilesBuffer { GpuTileData Tiles[]; };
layout(set = 2, binding = 5, std430) readonly buffer RegionsBuffer { GpuTextureRegion Regions[]; };
...
layout(set = 3, binding = 1, std430) readonly buffer MapBuffer { GpuMapTile Map[]; };
