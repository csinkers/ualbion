...
namespace UAlbion.Core.Veldrid.Sprites
{
    internal partial struct BlendedSpriteIntermediateData
    {
        public static VertexLayoutDescription GetLayout(bool input) => new(
            ...
            new VertexElementDescription((input ? "i" : "o") + "UvClamp1", VertexElementSemantic.TextureCoordinate, VertexElementFormat.Float4),
            ...
            new VertexElementDescription((input ? "i" : "o") + "UvClamp2", VertexElementSemantic.TextureCoordinate, VertexElementFormat.Float4),
