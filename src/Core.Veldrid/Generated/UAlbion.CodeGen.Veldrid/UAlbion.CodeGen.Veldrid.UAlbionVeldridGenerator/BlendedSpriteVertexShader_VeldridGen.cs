...
{
    internal partial class BlendedSpriteVertexShader
    {
        public static (string, string) ShaderSource()
        {
            return ("BlendedSpriteSV.h.vert", @"// !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
// UAlbion.Core.Veldrid.Sprites.GpuBlendedSpriteInstanceData
layout(location = 2) in uint iFlags;
layout(location = 3) in vec4 iInstancePos;
layout(location = 4) in vec2 iSize;
layout(location = 5) in vec2 iTexOffset1;
layout(location = 6) in vec2 iTexSize1;
layout(location = 7) in uint iTexLayer1;
layout(location = 8) in vec2 iTexOffset2;
layout(location = 9) in vec2 iTexSize2;
layout(location = 10) in uint iTexLayer2;
