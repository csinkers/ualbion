...
public struct InventoryId : IEquatable<InventoryId>
{
    public InventoryId(AssetId id)
    {
        Type = id.Type switch
        {
            ...
            AssetType.PartySheet => InventoryType.Player,
            AssetType.MonsterSheet => InventoryType.Monster,
    ...
    public AssetId ToAssetId() =>
        Type switch
        {
            ...
            InventoryType.Monster => new AssetId(AssetType.MonsterSheet, Id),
            _ => AssetId.None,
        };

    public AssetId ToSheetId() =>
        Type switch
        {
            InventoryType.Player => new AssetId(AssetType.PartySheet, Id),
            InventoryType.Monster => new AssetId(AssetType.MonsterSheet, Id),
            _ => AssetId.None,
        };
    ...
    public static AssetId ToAssetId(InventoryId id) => new(id.Type switch
    {
        ...
        InventoryType.Player => AssetType.PartySheet,
        InventoryType.Monster => AssetType.MonsterSheet,
