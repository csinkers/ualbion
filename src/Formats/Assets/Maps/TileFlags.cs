...
public enum TileFlags : uint
{
    ...
    MiscMask = BackAndForth | Unk12 | Unk18 | NoDraw | DebugDot,
    UnusedMask = ~(TypeMask | LayerMask | CollMask | SitMask | MiscMask),

    // Animation cycle options
    BackAndForth = 1,      // 0x00000001
    Type1      = 1 << 1,   // 0x00000002 // Overlay: Small orange debug marker in top left
    Type2      = 1 << 2,   // 0x00000004  
    Type4      = 1 << 3,   // 0x00000008  
    Type8      = 1 << 4,   // 0x00000010  
