...
{
    Normal    =  0, // Standard issue, can be underlay or overlay
    Underlay1 =  1, // Underlay
    Underlay2 =  2, // Underlay, celtic floors, toilet seats, random square next to pumps, top shelves of desks
    Underlay3 =  3, // Underlay, unused
    Overlay1  =  4, // Overlay
    Overlay2  =  5, // Overlay, only on continent maps?
    Overlay3  =  6, // Overlay
    Overlay4  =  7, // Overlay used on large plants on continent maps.
    Underlay4 =  8, // Underlay used on OkuloKamulos maps around fire
    Overlay5  = 12, // Overlay used on OkuloKamulos maps for covered fire / grilles
    Overlay6  = 14, // Overlay used on OkuloKamulos maps for open fire
...
public static class TileTypeExtensions
{
    public static int ToDepthOffset(this TileType type)
    {
        ...
        switch ((int)type & 0x7)
        {
            ...
            case (int)TileType.Overlay4: typeAdjust = 0; break;
