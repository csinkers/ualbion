...
[JsonConverter(typeof(ToStringJsonConverter<PictureId>))]
[TypeConverter(typeof(PictureIdConverter))]
public readonly struct PictureId : IEquatable<PictureId>, IEquatable<AssetId>, IComparable, IAssetId
{
