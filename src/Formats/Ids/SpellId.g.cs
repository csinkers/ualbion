...
[JsonConverter(typeof(ToStringJsonConverter<SpellId>))]
[TypeConverter(typeof(SpellIdConverter))]
public readonly struct SpellId : IEquatable<SpellId>, IEquatable<AssetId>, IComparable, IAssetId
{
    ...
    public static SpellId SerdesU8(string name, SpellId id, AssetMapping mapping, ISerdes s)
    {
    ...
    public static SpellId SerdesU16(string name, SpellId id, AssetMapping mapping, ISerdes s)
    {
        if (s == null) throw new ArgumentNullException(nameof(s));
    ...
    public static SpellId SerdesU16BE(string name, SpellId id, AssetMapping mapping, ISerdes s)
    {
        if (s == null) throw new ArgumentNullException(nameof(s));
    ...
    public static AssetType[] ValidTypes = { AssetType.Spell };
    public static SpellId Parse(string s) => AssetMapping.Global.Parse(s, ValidTypes);
