...
[JsonConverter(typeof(ToStringJsonConverter<SwitchId>))]
[TypeConverter(typeof(SwitchIdConverter))]
public readonly struct SwitchId : IEquatable<SwitchId>, IEquatable<AssetId>, IComparable, IAssetId
{
    ...
    public static AssetType[] ValidTypes = { AssetType.Switch };
    public static SwitchId Parse(string s) => AssetMapping.Global.Parse(s, ValidTypes);
