...
[Event("change_mana")]
public class ChangeManaEvent : DataChangeEvent
{
    ChangeManaEvent() { }
    public ChangeManaEvent(PartyMemberId partyMemberId, NumericOperation operation, ushort amount, byte unk3)
    {
    ...
    public static ChangeManaEvent Serdes(ChangeManaEvent e, AssetMapping mapping, ISerializer s)
    {
        if (s == null) throw new ArgumentNullException(nameof(s));
        e ??= new ChangeManaEvent();
        ...
        s.Assert(zeroed == 0, "ChangeManaEvent: Expected byte 4 to be 0");
        return e;
    }
    public override ChangeProperty ChangeProperty => ChangeProperty.Mana;
