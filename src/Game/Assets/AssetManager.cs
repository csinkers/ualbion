...
namespace UAlbion.Game.Assets
{
    public class AssetManager : Component, IAssetManager
    {
        ...
        public AlbionPalette LoadPalette(PaletteId id)
        {
            ...
            var commonPalette = (byte[])_modApplier.LoadAssetCached(AssetId.CommonPalette);
        ...
        public ITexture LoadTexture(ITextureId id) => (ITexture)_modApplier.LoadAssetCached(new SpriteId(id?.ToUInt32() ?? 0));
        ...
        public byte[] LoadSoundBanks() => (byte[]) _modApplier.LoadAssetCached(AssetId.SoundBank);
