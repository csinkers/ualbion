...
{
    public const string FontInfoPath = @"C:\Depot\bb\ualbion\mods\UATestDev\Fonts.json";
    public const string FontPngPath = @"C:\Depot\bb\ualbion\mods\UATestDev\Fonts.png";
    ...
    public static readonly uint[] RawPalette = {
    ...
    public static MultiFont? Font { get; private set; }
    public static SingleFont Font6 { get; private set; }
    public static SingleFont Font10 { get; private set; }
    public static AlbionPalette PaletteCommon { get; private set; }
    public static PaletteId Palette1Id { get; private set; }
    public static AlbionPalette Palette1 { get; private set; }
    public static TestTilemap Tileset1 { get; private set; }
